...
class ConfigurationManager:
    ...
    def __init__(self):
        self.config = self._read_yaml(CONFIG_FILE_PATH)
    ...
    def get_data_ingestion_config(self) -> DataIngestionConfig:
        ...
        return DataIngestionConfig(
            ...
            raw_train_data_path=Path(data_config["train_data_path"]),
            raw_test_data_path=Path(data_config["test_data_path"]),
            ingested_train_path=Path(artifact_config["train_file"]),
            ingested_test_path=Path(artifact_config["test_file"])
        )
    ...
    def get_data_validation_config(self) -> DataValidationConfig:
        ...
        return DataValidationConfig(
            root_dir=Path(artifact_config["root_dir"]),
            train_file_path=Path(ingestion_config["train_file"]),
            schema_file_path=SCHEMA_FILE_PATH,
            validation_report_file_path=Path(artifact_config["validation_report"]),
            validation_status_file_path=Path(artifact_config["validation_status"]),
        )
    ...
    def get_data_transformation_config(self) -> DataTransformationConfig:
        ...
        return DataTransformationConfig(
            root_dir=Path(artifact_config["root_dir"]),
            X_train_path=Path(artifact_config["X_train"]),
            y_train_path=Path(artifact_config["y_train"]),
            X_test_path=Path(artifact_config["X_test"]),
            y_test_path=Path(artifact_config["y_test"]),
            preprocessor_path=Path(artifact_config["preprocessor"]),
